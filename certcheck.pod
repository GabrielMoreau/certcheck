...
=head1 SYNOPSIS
 ...
 certcheck check [--base|-b certbase] [--pub|-b certbase.pub.pem] [--key|-k certbase.key.pem] [--chain|-c certbase.key.pem]
 certcheck text  [--base|-b certbase] [--pub|-b certbase.pub.pem]
 certcheck txt   [--base|-b certbase] [--pub|-b certbase.pub.pem]
 certcheck info  [--base|-b certbase] [--pub|-b certbase.pub.pem]
 certcheck version
 certcheck help
