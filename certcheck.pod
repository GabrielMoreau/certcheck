...
All subcommands have the C<--verbose> (C<-v>) option.
...
With the C<--verbose> (C<-v>) option, subcommands explicitly indicate certificate files (public part, private part, chain).
